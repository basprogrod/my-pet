...
const Quantiti = ({ quantity, onSelect, onChange }: QuantityProps) => {
  ...
  return (
    <div className="quantity">
      ...
      <button className="quantity__btn" onClick={handleClickByMinus}>-</button>
      <button className="quantity__btn right" onClick={handleClickByPlus}>+</button>
      <input type="text" className="quantity__inp" value={quantity} onChange={onChange} />
    </div>
  )
}
